...
public class Box {
    ...
    /*
     * Constructor from BoundBox.
     */
    public Box(final net.minecraft.util.math.Box aabb) {
    ...
    public void save(NbtCompound nbt) {
        NbtCompound coordsNbt1 = new NbtCompound();
        NbtCompound coordsNbt2 = new NbtCompound();
     ...
     * @return
     */
    public static Box load(NbtCompound nbt) {
        Box box;
        ICoords c1;
        ICoords c2;
