...
public class Coords implements ICoords {
    ...
    public ICoords offset(int x, int y, int z) {
        return new Coords(toPos().add(x, y, z));
    }
    ...
    public ICoords add(ICoords coords) {
        return new Coords(this.x + coords.getX(), this.y + coords.getY(), this.z + coords.getZ());
    }
    ...
    public ICoords rotate90(int width) {
        return new Coords(width - this.getZ() - 1, this.getY(), this.getX());
    }
    ...
    public ICoords rotate180(int depth, int width) {
        return new Coords(width - this.getX() - 1, this.getY(), depth - this.getZ() - 1);
    }
    ...
    public ICoords rotate270(int depth) {
        return new Coords(this.z, this.y, depth - this.getX() - 1);
    }
     ...
     */
    @Override
    public ICoords load(NbtCompound tag) {
        Integer x = null;
        Integer y = null;
        Integer z = null;
